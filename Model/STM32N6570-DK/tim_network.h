/**
  ...
  ******************************************************************************
  */
#ifndef STAI_TIM_NETWORK_H
#define STAI_TIM_NETWORK_H
...
#define STAI_TIM_NETWORK_ORIGIN_MODEL_NAME         "tim_transformer_kaggle_custom_1p5m_nomask_stfixed"
#define STAI_TIM_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x36f243b0f1982cb31e58dc9125d44415"

/*  Generated model name and signature  */
#define STAI_TIM_NETWORK_MODEL_NAME                "tim_network"
#define STAI_TIM_NETWORK_MODEL_SIGNATURE           (0xd1f86e8e7a97b6d0)


/*****************************************************************************/
/*  Macros to declare network context size and required alignment  */
#define STAI_TIM_NETWORK_CONTEXT_ALIGNMENT   8
#define STAI_TIM_NETWORK_CONTEXT_SIZE        (sizeof(_stai_tim_network_context))

/*  Macro to declare network flags  */
#define STAI_TIM_NETWORK_FLAGS               (STAI_FLAG_INPUTS|STAI_FLAG_OUTPUTS|STAI_FLAG_WEIGHTS)

/*  Macro to declare number of network C nodes generated  */
#define STAI_TIM_NETWORK_NODES_NUM           (104)

/*  Macro to declare number macc for generated network model  */
#define STAI_TIM_NETWORK_MACC_NUM            (76063518)

/*  Macros to declare input buffers characteristics  */
#define STAI_TIM_NETWORK_IN_NUM              (1)
#define STAI_TIM_NETWORK_IN_SIZE_BYTES       (132)

#define STAI_TIM_NETWORK_IN_ALIGNMENTS \
  { 4}
#define STAI_TIM_NETWORK_IN_NAMES \
  { NULL}
#define STAI_TIM_NETWORK_IN_FORMATS \
  { STAI_FORMAT_S32}
#define STAI_TIM_NETWORK_IN_SIZES \
  {32}
#define STAI_TIM_NETWORK_IN_SIZES_BYTES \
  {128}

#define STAI_TIM_NETWORK_IN_1_ALIGNMENT   4
#define STAI_TIM_NETWORK_IN_1_NAME        (NULL)
#define STAI_TIM_NETWORK_IN_1_FLAGS       (STAI_FLAG_INPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_TIM_NETWORK_IN_1_FORMAT      (STAI_FORMAT_S32)
#define STAI_TIM_NETWORK_IN_1_SHAPE       {1,32}
#define STAI_TIM_NETWORK_IN_1_BATCH       (1)
#define STAI_TIM_NETWORK_IN_1_CHANNEL     (32)
#define STAI_TIM_NETWORK_IN_1_RANK        (1)
#define STAI_TIM_NETWORK_IN_1_SIZE        (32)
#define STAI_TIM_NETWORK_IN_1_SIZE_BYTES  (128)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_TIM_NETWORK_OUT_NUM             (1)
#define STAI_TIM_NETWORK_OUT_SIZE_BYTES      (40)
#define STAI_TIM_NETWORK_OUT_ALIGNMENTS \
  { 4}
#define STAI_TIM_NETWORK_OUT_NAMES \
  { NULL}
#define STAI_TIM_NETWORK_OUT_FORMATS \
  { STAI_FORMAT_FLOAT32}
#define STAI_TIM_NETWORK_OUT_SIZES \
  { 9}
#define STAI_TIM_NETWORK_OUT_SIZES_BYTES \
  {36}

#define STAI_TIM_NETWORK_OUT_1_ALIGNMENT   4
#define STAI_TIM_NETWORK_OUT_1_NAME        (NULL)
#define STAI_TIM_NETWORK_OUT_1_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_TIM_NETWORK_OUT_1_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_TIM_NETWORK_OUT_1_SHAPE       {1,9}
#define STAI_TIM_NETWORK_OUT_1_BATCH       (1)
#define STAI_TIM_NETWORK_OUT_1_CHANNEL     (9)
#define STAI_TIM_NETWORK_OUT_1_RANK        (1)
#define STAI_TIM_NETWORK_OUT_1_SIZE        ((9))
#define STAI_TIM_NETWORK_OUT_1_SIZE_BYTES  (36)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_TIM_NETWORK_ACTIVATIONS_SIZE              (114688)
#define STAI_TIM_NETWORK_ACTIVATIONS_SIZE_BYTES        (114688)
#define STAI_TIM_NETWORK_ACTIVATIONS_ALIGNMENTS \
  { 4}
#define STAI_TIM_NETWORK_ACTIVATIONS_SIZES \
  { 114688}
#define STAI_TIM_NETWORK_ACTIVATIONS_NUM               (1)

#define STAI_TIM_NETWORK_ACTIVATION_1_FLAGS      (STAI_FLAG_ACTIVATIONS)
#define STAI_TIM_NETWORK_ACTIVATION_1_SIZE       (114688)
#define STAI_TIM_NETWORK_ACTIVATION_1_SIZE_BYTES (114688)
#define STAI_TIM_NETWORK_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_TIM_NETWORK_WEIGHTS_NUM                  (1)
#define STAI_TIM_NETWORK_WEIGHTS_SIZE                  (1253712)
#define STAI_TIM_NETWORK_WEIGHTS_SIZE_BYTES            (1253712)
#define STAI_TIM_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4}
#define STAI_TIM_NETWORK_WEIGHTS_SIZES \
  { 1253712}
#define STAI_TIM_NETWORK_WEIGHTS_NUM        (1)
#define STAI_TIM_NETWORK_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_TIM_NETWORK_WEIGHT_1_SIZE        (1253712)
#define STAI_TIM_NETWORK_WEIGHT_1_SIZE_BYTES  (1253712)


/*****************************************************************************/
/*  Macros to declare states buffers characteristics  */
#define STAI_TIM_NETWORK_STATES_SIZE              (0)
#define STAI_TIM_NETWORK_STATES_SIZE_BYTES        (0)
#define STAI_TIM_NETWORK_STATES_ALIGNMENTS        {}
#define STAI_TIM_NETWORK_STATES_SIZES             { 0, }
#define STAI_TIM_NETWORK_STATES_NUM               (0)

#define STAI_TIM_NETWORK_STATE_1_FLAGS            (0x0)
#define STAI_TIM_NETWORK_STATE_1_ALIGNMENT        4
#define STAI_TIM_NETWORK_STATE_1_SIZE             (0)
#define STAI_TIM_NETWORK_STATE_1_SIZE_BYTES       (0)
/*****************************************************************************/
...
typedef struct {
  ...
  stai_ptr                     _activations[STAI_TIM_NETWORK_ACTIVATIONS_NUM];
  stai_ptr                     _weights[STAI_TIM_NETWORK_WEIGHTS_NUM];
  stai_ptr                     _inputs[STAI_TIM_NETWORK_IN_NUM];
  stai_ptr                     _outputs[STAI_TIM_NETWORK_OUT_NUM];
} _stai_tim_network_context;
 ...
 *          @ref STAI_TIM_NETWORK_CONTEXT_SIZE or @ref stai_tim_network_get_context_size(void) API
 ...
 *          on the input buffers whose memory adresses are retrived using @ref stai_tim_network_get_inputs() API.
 *          Alternatively the application could allocate the inputs and set the addresses using the
 *          @ref stai_tim_network_set_inputs() API. Similar behaviour is expected for the network outputs handling.
 *          The features of each input / output buffer (format, byte size, etc.)may be queried using
 *          @ref stai_tim_network_get_info() API or the set of specific macros available in this header file.
 ...
 *          @ref stai_tim_network_get_outputs() API.
 * @param[in] network network context opaque pointer
 ...
 */
STAI_API_ENTRY
stai_size stai_tim_network_get_context_size(void);
 ...
 *          @ref stai_tim_network_set_states() dual API
 * @param[in] network network context opaque pointer
 ...
 *          @ref stai_tim_network_run() API. It is a helper routine that could be used by an application for debug
